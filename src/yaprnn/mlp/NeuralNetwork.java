...
public interface NeuralNetwork {
	 ...
	 * @param layer Die Schicht (Startet mit 0).
	 ...
	 * @param layer Die Hintere dieser beiden Schichten (Startet mit 1).
	 * @return Eine Gewichtsmatrix der Form double[][], wobei die erste Dimension die Neuronen der hinteren Schicht ist und die zweite die Neuronen der
